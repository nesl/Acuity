...
bool operator==(const ::hark_msgs::HarkFFTVal_<ContainerAllocator1> & lhs, const ::hark_msgs::HarkFFTVal_<ContainerAllocator2> & rhs)
{
  return lhs.fftdata_real == rhs.fftdata_real &&
