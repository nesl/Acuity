...
bool operator==(const ::hark_msgs::HarkWaveVal_<ContainerAllocator1> & lhs, const ::hark_msgs::HarkWaveVal_<ContainerAllocator2> & rhs)
{
  return lhs.wavedata == rhs.wavedata;
}
