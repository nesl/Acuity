// Generated by gencpp from file hark_params/SourceTracker.msg
// DO NOT EDIT!
...
struct SourceTracker_
{
  ...
  _pause_length_type pause_length;

   typedef float _min_src_interval_type;
  _min_src_interval_type min_src_interval;

   typedef float _min_tfindex_interval_type;
  _min_tfindex_interval_type min_tfindex_interval;

   typedef uint8_t _compare_mode_type;
  _compare_mode_type compare_mode;



// reducing the odds to have name collisions with Windows.h 
#if defined(_WIN32) && defined(DEG)
  #undef DEG
#endif
#if defined(_WIN32) && defined(TFINDEX)
  #undef TFINDEX
#endif
...
bool operator==(const ::hark_params::SourceTracker_<ContainerAllocator1> & lhs, const ::hark_params::SourceTracker_<ContainerAllocator2> & rhs)
{
  return lhs.thresh == rhs.thresh &&
    lhs.pause_length == rhs.pause_length &&
    lhs.min_src_interval == rhs.min_src_interval &&
    lhs.min_tfindex_interval == rhs.min_tfindex_interval &&
    lhs.compare_mode == rhs.compare_mode;
}
...
template <class ContainerAllocator>
struct IsMessage< ::hark_params::SourceTracker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hark_params::SourceTracker_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::hark_params::SourceTracker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::hark_params::SourceTracker_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hark_params::SourceTracker_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hark_params::SourceTracker_<ContainerAllocator> const>
  : FalseType
  { };
