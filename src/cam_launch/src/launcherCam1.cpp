...
void publishDummy()
{
    ...
    empty_cloud->header.frame_id = "backgone1";
...
void process(pcl::PointCloud<pcl::PointXYZRGB>::Ptr data, pcl::PointCloud<pcl::PointXYZRGB>::Ptr data_down, int frameNum)
{
    ...
    person_clusters_filtered->header.frame_id = "backgone1";
...
int main(int argc, char *argv[])
{
    ...
    rs2::config cfg;
    rs2::context ctx;
    color_publisher = nh.advertise<sensor_msgs::Image>("/camera1/color", 2);
    subtracted_publisher = nh.advertise<pcl::PointCloud<pcl::PointXYZRGB>>("/camera1/clouds/subtracted", 2);
    source_publisher = nh.advertise<HarkSource>("/camera1/sources", 2);
    ...
    { // ros::ok()??
        ...
        double receivedCloud = ros::Time::now().toSec();
        ...
        pcl_points->header.frame_id = "PC1";
        color_img.header.frame_id = "color_img1";
        ...
        std::cout << ros::Time::now().toSec() - receivedCloud << std::endl;
    }
}
